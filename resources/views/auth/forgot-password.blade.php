<x-layouts.fullpage>
    <x-seo title="Recupera la tua password - CLUSTER-A" />
            ...
            <div class="relative container px-4 mx-auto">
                <div class="max-w-lg md:max-w-xl py-14 px-6 xs:px-12 lg:px-16 mx-auto bg-white rounded-4xl shadow-lg">
                    ...
                    <form method="POST" action="{{ route('password.email') }}" class="font-display">
                        ...
                        <button class="btn w-full btn-primary btn-lg mb-6 relative overflow-hidden group"
                            type="submit">
                            <div
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        ...
                        <button
                            class="relative cursor-pointer group block w-full mb-6 py-3 px-5 text-primary-700 hover:text-primary-500 text-center text-sm font-semibold rounded-full overflow-hidden"
                            type="submit">
                            <div
