...
@if ($published_time && $modified_time)
    <meta property="article:published_time" content="{{ Carbon\Carbon::parse($published_time)->toIso8601String() }}" />
    <meta property="article:modified_time" content="{{ Carbon\Carbon::parse($modified_time)->toIso8601String() }}" />
@endif
